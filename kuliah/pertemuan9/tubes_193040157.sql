...
CREATE TABLE `makanan` (
  ...
  `resep` varchar(500) DEFAULT NULL,
...
INSERT INTO `makanan` (`no`, `foto`, `nama`, `resep`, `asal`, `harga`) VALUES
(1, 'sate.jpg', 'Sate Madura', 'tusukan sate, 500 gram daging ayam potong dadu, 4 sdm kecap manis, 2 sdm margarin, 4 buah cabe merah, 5 butir bawang merah, 3 siung bawang putih, 2 butir kemiri, 50 gram kacang tanah goreng kemudian haluskan, 50 gram kecap manis, 200 ml air, 1 sdm gula merah, 2 buah jeruk limau, garam secukupnya, minyak goreng secukupnya.', 'Jawa Timur', '10000/8 tusuk'),
